...
namespace ox {
    ...
    public:
        ...
        struct mode {
            ...
            write  = u8{0b00000010};
            static OX_CAUTO
            append = u8{0b00000100};
            static OX_CAUTO
            create = u8{0b00001000};
        };
        ...
        public:
            ...
            const void* operator[](usize offset) const noexcept { return static_cast<const basic_byte*>(_data) + offset; }
    ...
    template<usize N = 65536>
    struct buf_stack_writer {
